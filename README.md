...
- `Срезы` - логическое описание SliceDefinition.
- `Оценка и загрузка` - SliceEstimate и MaterializationPlan.
- `Локальные данные` - DumpManifest и готовность таблиц.
- `Обогащение` - точечная дозагрузка недостающих сущностей.
- `Индексы` - локальные P, C, C_frac, CPP, h, i10, g, ISLV/IUPV/LRDI.
- `Статистика` - распределения, scatter, устойчивость и сравнение рейтингов.
