...
В интерфейсе по умолчанию используются общеупотребимые показатели:
публикации, цитирования, средняя цитируемость, индекс Хирша, i10-индекс и
g-индекс. Дополнительные исследовательские индексы доступны в аналитическом
...
`f5/fm5` в этом DSS специально помечены как operational definition. Перед
