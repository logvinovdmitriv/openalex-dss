...
const metricDescriptions: Record<string, string> = {
  ...
  iupv: "Формула рейтинга на процентильной шкале: объединяет число публикаций, индекс Хирша и долевые цитирования внутри выбранного среза.",
  islv: "Формула рейтинга на процентильной шкале: объединяет индекс Хирша, долевые цитирования, индекс g, i10 и публикации с поправкой на концентрацию цитирований.",
...
const metricFormulas: Record<string, string> = {
  ...
  iupv: "R₁(a) = 100 · (pr(P) · pr(h) · pr(Cд))^(1/3)",
