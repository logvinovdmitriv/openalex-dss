...
const metricLabels: Record<string, string> = {
  ...
  iupv: "IUPV: процентильный интегральный показатель",
  islv: "ISLV: сбалансированный показатель вклада",
...
const metricDescriptions: Record<string, string> = {
  ...
  iupv: "Интегральный показатель на процентильной шкале: объединяет публикации, индекс Хирша и долевые цитирования внутри выбранного среза.",
  islv: "Сбалансированный показатель на процентильной шкале: объединяет h, долевые цитирования, g, i10 и публикации с поправкой на концентрацию цитирований.",
