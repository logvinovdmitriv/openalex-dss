...
const FORMULA_VARIABLES = [
  ...
  { token: "n_cited5", label: "Работы с 5+ цитированиями" },
  { token: "frac_cited5", label: "Долевой вклад в работы с 5+ цитированиями" },
...
export function metricFormulaMarkup(metricName: string) {
  const formulas: Record<string, string> = {
    ...
    n_cited5: `<math><mrow><mi>n_cited5</mi><mo>(</mo><mi>a</mi><mo>)</mo><mo>=</mo><mo>|</mo><mo>{</mo><mi>i</mi><mo>:</mo><msub><mi>c</mi><mi>i</mi></msub><mo>≥</mo><mn>5</mn><mo>}</mo><mo>|</mo></mrow></math>`,
    frac_cited5: `<math><mrow><mi>frac_cited5</mi><mo>(</mo><mi>a</mi><mo>)</mo><mo>=</mo><munderover><mo>∑</mo><mrow><msub><mi>c</mi><mi>i</mi></msub><mo>≥</mo><mn>5</mn></mrow><msub><mi>W</mi><mi>a</mi></msub></munderover><msub><mi>w</mi><mi>i</mi></msub></mrow></math>`,
