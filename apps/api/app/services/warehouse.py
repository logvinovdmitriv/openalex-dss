...
from app.services import cache_engine, custom_metrics, distribution_engine, metric_registry, ranking_engine, storage_paths, table_engine, table_pagination
...
EXTENDED_LINE_CHART_METRICS = (*CORE_LINE_CHART_METRICS, "cpp", "m_local", "top1_share", "rfi_log_frac", "pci", "iupv_s", "iupv_sb", "islv", "lrdi")
...
def _quote_sql_identifier(value: str) -> str:
    return table_pagination.quote_sql_identifier(value)
